...
Now part of the [human-ai-reliance](https://github.com/uw-share-lab/human-ai-reliance) monorepo, under [`generating-explanations/`](https://github.com/uw-share-lab/human-ai-reliance/tree/main/generating-explanations). Full commit history was preserved. This repo is archived and read-only.
